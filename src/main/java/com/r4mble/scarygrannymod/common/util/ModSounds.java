...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> GRANNY_STEPS =
            SOUNDS.register("granny_steps", () -> new SoundEvent(new ResourceLocation(ScaryGrannyMod.MOD_ID, "granny_steps")));
    ;
